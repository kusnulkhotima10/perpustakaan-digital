                                    ...
                                    <div class="card-body">
                                        <?php
                                            if(isset($_POST['register'])){
                                                ...
                                                $insert = mysqli_query($koneksi, "INSERT INTO user(nama,email,alamat,no_telepon,username,password,level) VALUES('$nama','$email','$alamat','$no_telepon','$username','$level','$password')");
                                        ...
                                        <form method="post">
                                             <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" required name="nama" placeholder="Masukan Nama Legkap" />
                                            </div>
                                            <div class="form-group">
